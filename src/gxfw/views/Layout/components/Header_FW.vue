  ...
  <div class="header">
    ...
    <div style="width: auto;">
      ...
      <div class="loginlast"  v-show="isLogin">
        ...
        <!--<span v-if="hasPerm('/manage/person/shopCar') && isLogin" title="购物车2"  style="padding-right: 20px;display: inline-block;">-->
  ...
  export default {
      ...
      var validateAccount = (rule, value, callback) => {
        ...
        if (value === '') {
          ...
          if (regPass.test(value)) {
            ...
            callback(new Error('1字母开头, 只能包含英文字母, 数字, 下划线, 长度最少为5位,不能超过20位'))
          }
        }
      }
      var validateAccountdl = (rule, value, callback) => {
        ...
        if (value === '') {
          ...
          if (regPass.test(value)) {
            ...
            callback(new Error('2字母开头,只能包含英文字母,数字,下划线,长度5-20位'))
          }
        }
      }
    ...
    created () {
      ...
      if (this.$route.query.token) {
        ...
        this.setToken(this.$route.query.data)
