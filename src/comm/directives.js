import Vue from 'vue'
import {HeartListern} from './directives/eventBus'
  ...
  bind (el, binding, vnode, oldVnode) {
    ...
    dialogHeaderEl.onmousedown = (e) => {
      ...
      document.onmousemove = function (e) {
        ...
        if (finallyL < 0) {} else if (finallyL > dragDom.offsetParent.clientWidth - dragDom.clientWidth - dragDom.offsetParent.offsetLeft) {
          finallyL = dragDom.offsetParent.clientWidth - dragDom.clientWidth - dragDom.offsetParent.offsetLeft
        }

        if (finallyT < 0) {} else if (finallyT > dragDom.offsetParent.clientHeight - dragDom.clientHeight - dragDom.offsetParent.offsetLeft) {
          (
